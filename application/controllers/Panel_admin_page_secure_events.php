...
class Panel_admin_page_secure_events extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        $this->label_name_and_input_name = array(
            ...
            "Şəkil" => "file",//burda name file olmalidi bu deyisse islemiycey kod inputun oz nameini asagida ayrica verilir
            "Tədbirin vaxdı" => "date",
        ...
        $this->update_link                    = base_url("panel_admin_page_secure_events_secure_controller_update/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->add_link                       = base_url("panel_admin_page_secure_events_secure_controller_add/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->delete_link                    = base_url("panel_admin_page_secure_events_secure_controller_delete/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->get_data_for_update_modal_link = base_url("panel_admin_page_secure_events_secure_controller_get_data_for_update/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->success_link                   = base_url("panel_admin_page_secure_events_secure_controller/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->error_link                     = base_url("panel_admin_page_secure_events_secure_controller/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->get_data_link                  = base_url("panel_admin_page_secure_events_secure_controller_get_data/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
    }
    ...
    public function index()
    {
        ...
        $this->load->view('admin/events/whole_page', $data);
    }
