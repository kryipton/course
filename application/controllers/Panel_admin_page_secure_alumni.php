...
class Panel_admin_page_secure_alumni extends MY_Controller{
    ...
    {
        parent::__construct();
        $this->table_name = "alumni";
        $this->upload_path = "uploads/alumni/";
        $this->label_name_and_input_name = array(
            ...
            "Məzun olduqu il" => "graduated_date",
        ...
        $this->update_link                    = base_url("panel_admin_page_secure_alumni_secure_controller_update/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->add_link                       = base_url("panel_admin_page_secure_alumni_secure_controller_add/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->delete_link                    = base_url("panel_admin_page_secure_alumni_secure_controller_delete/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->get_data_for_update_modal_link = base_url("panel_admin_page_secure_alumni_secure_controller_get_data_for_update/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->success_link                   = base_url("panel_admin_page_secure_alumni_secure_controller/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->error_link                     = base_url("panel_admin_page_secure_alumni_secure_controller/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
        $this->get_data_link                  = base_url("panel_admin_page_secure_alumni_secure_controller_get_data/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
    }
    ...
    public function index()
    {
        ...
        $select_name_and_table_name = array(
            "course_id.Kursun adı" => "courses.name_az"
        );//eger select yoxdusa bos qoya bilerik
        ...
        $this->load->view('admin/alumni/whole_page', $data);
    }
